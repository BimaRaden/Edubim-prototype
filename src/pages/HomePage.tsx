  ...
  return (
    <div className="max-w-6xl mx-auto relative min-h-screen pb-20">
      <div className="mb-10 text-center">
        <h1 className="text-4xl font-bold text-emerald-400 mb-4">Welcome to EduBim</h1>
        <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
          Jelajahi materi pembelajaran berkualitas secara gratis. Hubungi developer untuk mendapatkan kode akses.
        </p>
