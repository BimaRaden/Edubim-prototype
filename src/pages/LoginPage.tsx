      ...
      <div className={`w-full max-w-md bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden transform transition-all duration-500 ${
        ...
        <div className="py-8 px-6 sm:px-10">
          <div className="text-center mb-8">
            <h2 className="mt-4 text-3xl font-bold text-emerald-500">Welcome to EduBim</h2>
            <p className="mt-2 text-gray-400">Hubungi developer untuk mendapatkan kode akses gratis</p>
          </div>
